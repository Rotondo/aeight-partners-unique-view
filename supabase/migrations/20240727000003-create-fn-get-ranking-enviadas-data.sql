CREATE OR REPLACE FUNCTION get_ranking_parceiros_enviadas_data(
...
BEGIN
    RETURN QUERY
    SELECT
        COALESCE(empresa_origem.nome, 'Desconhecido') AS parceiro_nome,
    ...
    WHERE
        empresa_origem.tipo = 'parceiro' AND empresa_destino.tipo = 'intragrupo'
