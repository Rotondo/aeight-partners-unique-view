  ...
  public: {
    Tables: {
      associacoes_parceiro_etapa: {
        ...
        Relationships: [
          {
            foreignKeyName: "associacoes_parceiro_etapa_etapa_id_fkey"
            columns: ["etapa_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "associacoes_parceiro_etapa_parceiro_id_fkey"
            columns: ["parceiro_id"]
            isOneToOne: false
            referencedRelation: "parceiros_mapa"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "associacoes_parceiro_etapa_subnivel_id_fkey"
            columns: ["subnivel_id"]
            isOneToOne: false
      ...
      subniveis_etapa: {
        ...
        Relationships: [
          {
            foreignKeyName: "subniveis_etapa_etapa_id_fkey"
            columns: ["etapa_id"]
            isOneToOne: false
            referencedRelation: "etapas_jornada"
            referencedColumns: ["id"]
