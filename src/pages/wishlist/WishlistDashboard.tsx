...
const WishlistDashboard: React.FC = () => {
  console.log("[WishlistDashboard] Componente renderizando...");
  
  const navigate = useNavigate();
  const { toast } = useToast();
  
  // Primeiro vamos testar sem usar o hook useWishlist para ver se o problema é no contexto
  try {
    const { 
      wishlistItems, 
      empresasClientes, 
    ...
    console.log("[WishlistDashboard] Hook useWishlist funcionando, dados:", {
    ...
    console.error("[WishlistDashboard] Erro no hook useWishlist:", error);
          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              <div className="text-red-500">
                ...
                <h3 className="text-lg font-semibold">Erro no Contexto</h3>
                <p className="text-sm text-muted-foreground">
                  O contexto WishlistProvider não está disponível.
                </p>
              </div>
