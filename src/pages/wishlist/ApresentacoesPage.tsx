...
import { Plus, Search, Presentation, Calendar, CheckCircle, XCircle } from "lucide-react";
import { format } from "date-fns";
import { ptBR } from "date-fns/locale";
import { StatusApresentacao, TipoApresentacao } from "@/types";

const ApresentacoesPage: React.FC = () => {
  const { apresentacoes, loading } = useWishlist();
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center mb-4">
                {searchTerm || statusFilter !== "all" ? "Tente ajustar os filtros de busca" : "Registre a primeira apresentação"}
              </p>
              <Button>
                <Plus className="mr-2 h-4 w-4" />
                Registrar Apresentação
